...
v25.Text = "F3X replication GUI developed by retster#6440\nExecute Scripts Which are replicated to the server.";
...
local function v273()
	...
	v294.Parent.MouseButton1Click:Connect(function()
...
local function v274()
	...
	v295.Parent.MouseButton1Click:Connect(function()
		...
		function Bum(v571)
			...
			if v571.Character:FindFirstChild("Part1") then
				...
				spawn(function()
					CreatePart(v571.Character:WaitForChild("Right Leg").CFrame * CFrame.new(0, 1, 0.6), v571.Character);
					SetName(v571.Character.Part, "Part1");
					CreatePart(v571.Character:WaitForChild("Left Leg").CFrame * CFrame.new(0, 1, 0.6), v571.Character);
...
local function v275()
	...
	v296.Parent.MouseButton1Click:Connect(function()
...
local function v276()
	...
	v297.Parent.MouseButton1Click:Connect(function()
...
local function v277()
	...
	v298.Parent.MouseButton1Click:Connect(function()
...
local function v278()
	...
	v299.Parent.MouseButton1Click:Connect(function()
...
local function v279()
	...
	v300.Parent.MouseButton1Click:Connect(function()
		...
		while wait(0.5) do
			...
			spawn(function()
				...
				for v1502, v1503 in game.Workspace:GetDescendants() do
					if ((v1503.Name == "Part") and (v1503.Parent == workspace) and (v1503.CFrame.x == math.floor(xloc)) and (v1503.CFrame.z == math.floor(zloc))) then
...
local function v280()
	...
	v301.Parent.MouseButton1Click:Connect(function()
		...
		while wait(0.5) do
			...
			spawn(function()
				...
				for v1506, v1507 in game.Workspace:GetDescendants() do
					if ((v1507.Name == "Part") and (v1507.Parent == workspace) and (v1507.CFrame.x == math.floor(xloc)) and (v1507.CFrame.z == math.floor(zloc))) then
...
local function v281()
	...
	v302.Parent.MouseButton1Click:Connect(function()
		...
		function Thomas(v934)
			...
			v357.HumanoidRootPart.Touched:connect(function(v1465)
...
local function v282()
	...
	v303.Parent.MouseButton1Click:Connect(function()
...
local function v284()
	...
	v309.Parent.MouseButton1Click:Connect(function()
...
local function v285()
	...
	v310.Parent.MouseButton1Click:Connect(function()
...
local function v286()
	...
	v311.Parent.MouseButton1Click:Connect(function()
		...
		function Boob(v1156)
			...
			if v1156.Character:FindFirstChild("Boob2") then
				...
				spawn(function()
					CreatePart(v1156.Character:WaitForChild("Right Leg").CFrame * CFrame.new(0, 2, - 0.6), v1156.Character);
					SetName(v1156.Character.Part, "Boob1");
					CreatePart(v1156.Character:WaitForChild("Left Leg").CFrame * CFrame.new(0, 2, - 0.6), v1156.Character);
...
local function v287()
	...
	v312.Parent.MouseButton1Click:Connect(function()
		...
		function Sky(v1222)
			...
			for v1478, v1479 in game.Workspace:GetDescendants() do
				if (v1479:IsA("BasePart") and (v1479.CFrame.x == math.floor(e)) and (v1479.CFrame.z == math.floor(g))) then
					SetName(v1479, "Sky");
					AddMesh(v1479);
...
local function v288()
	...
	v313.Parent.MouseButton1Click:Connect(function()
		...
		function Penis(v1281)
			...
			if v1281.Character:FindFirstChild("Penis") then
				...
				spawn(function()
					CreatePart(v1281.Character:WaitForChild("Right Leg").CFrame * CFrame.new(- 0.8, 1, - 0.6), v1281.Character);
					SetName(v1281.Character.Part, "Balls1");
					CreatePart(v1281.Character:WaitForChild("Left Leg").CFrame * CFrame.new(0.8, 1, - 0.6), v1281.Character);
				...
				print("done");
				spawn(function()
					CreatePart(v1281.Character:WaitForChild("Torso").CFrame * CFrame.new(0, -1, - 1.3), v1281.Character);
					SetName(v1281.Character.Part, "Penis");
					CreatePart(v1281.Character:WaitForChild("Torso").CFrame * CFrame.new(0, -1, - 2.5), v1281.Character);
...
local function v289()
	...
	v314.Parent.MouseButton1Click:Connect(function()
...
local function v290()
	...
	v315.Parent.MouseButton1Click:Connect(function()
...
local function v291()
	...
	v316.Parent.MouseButton1Click:Connect(function()
...
local function v292()
	...
	function dragify(v457)
		...
		function updateInput(v1449)
			...
			local v1451 = UDim2.new(startPos.X.Scale, startPos.X.Offset + v1450.X, startPos.Y.Scale, startPos.Y.Offset + v1450.Y);
			game:GetService("TweenService"):Create(v457, TweenInfo.new(0.3), {
				Position = v1451
			}):Play();
		end
		v457.InputBegan:Connect(function(v1452)
			if (((v1452.UserInputType == Enum.UserInputType.MouseButton1) or (v1452.UserInputType == Enum.UserInputType.Touch)) and (v318:GetFocusedTextBox() == nil)) then
				dragToggle = true;
				dragStart = v1452.Position;
				startPos = v457.Position;
				v1452.Changed:Connect(function()
		...
		v457.InputChanged:Connect(function(v1453)
			if ((v1453.UserInputType == Enum.UserInputType.MouseMovement) or (v1453.UserInputType == Enum.UserInputType.Touch)) then
				dragInput = v1453;
			end
		end);
		game:GetService("UserInputService").InputChanged:Connect(function(v1454)
