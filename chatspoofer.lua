local Material = loadstring(game:HttpGet("https://raw.githubusercontent.com/coolguy9986/Scripts/refs/heads/main/chatspoofermaterial.lua"))()
local SubmitButton

local UI =
    Material.Load(
        {
            Title = "Chat Spoofer Made By Spajky",
            Style = 2,
            SizeX = 400,
            SizeY = 220,
            Theme = "Dark"
